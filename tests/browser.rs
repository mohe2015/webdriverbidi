...
mod create_user_context {
    ...
    async fn test_create_context() {
        ...
        let user_context = utils::create_user_context(&mut bidi_session).await.unwrap();
        let ids = utils::get_user_context_ids(&mut bidi_session)
            .await
            .unwrap();
    ...
    async fn test_unique_id() {
        ...
        let first_context = utils::create_user_context(&mut bidi_session).await.unwrap();
        let other_context = utils::create_user_context(&mut bidi_session).await.unwrap();
        let ids = utils::get_user_context_ids(&mut bidi_session)
            .await
            .unwrap();
    ...
    async fn test_storage_isolation() {
        ...
        let tab_first_context = utils::new_tab_in_user_context(&mut bidi_session, first_context)
            .await
            .unwrap();
        let tab_other_context = utils::new_tab_in_user_context(&mut bidi_session, other_context)
            .await
            .unwrap();
        ...
        let initial_tab_first_context_storage =
            utils::get_local_storage(&mut bidi_session, tab_first_context.as_str(), test_key)
                .await
                .unwrap();

        let initial_tab_other_context_storage =
            utils::get_local_storage(&mut bidi_session, tab_other_context.as_str(), test_key)
                .await
                .unwrap();
...
mod get_client_windows {
    ...
    async fn test_open_and_close() {
        ...
        let initial_windows = utils::get_client_windows(&mut bidi_session).await.unwrap();

        let new_browsing_context = utils::new_window(&mut bidi_session).await.unwrap();

        let updated_windows = utils::get_client_windows(&mut bidi_session).await.unwrap();
        ...
        let final_windows = utils::get_client_windows(&mut bidi_session).await.unwrap();
        utils::close_session(&mut bidi_session).await.unwrap();
    ...
    async fn test_activate_client_windows() {
        ...
        let initial_all_windows = utils::get_client_windows(&mut bidi_session).await.unwrap();
        ...
        let final_all_windows = utils::get_client_windows(&mut bidi_session).await.unwrap();
...
mod get_user_contexts {
    ...
    async fn test_create_remove_contexts() {
        ...
        let user_context_1 = utils::create_user_context(&mut bidi_session).await.unwrap();
        let user_context_2 = utils::create_user_context(&mut bidi_session).await.unwrap();
